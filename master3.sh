#!/bin/bash
# Cluster Multi-Master com K8s usando Vagrant - MASTER3
...
# No Master3
echo " Informando ao Kubelet o ip da interface do MASTER3 "
...
#    --control-plane --certificate-key 6cfd7416e3cb9bf4227132d9c65ed347e79dd56b2391f960dec4b667dcf793d1  --apiserver-advertise-address=172.27.11.30